...
class WasteGarbageViewAdapter(private val context: Context,private val list : ArrayList<Dto_Home_garbage>) : RecyclerView.Adapter<WasteGarbageViewAdapter.viewHolder>() {
